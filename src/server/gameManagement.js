...
function calcPlayerSeconds(gameId)
{
    ...
    if( allGames[gameId].playersInfo[allGames[gameId].activePlayer].playerTime < 0)
        allGames[gameId].playersInfo[allGames[gameId].activePlayer].playerTime =  (allGames[gameId].playersInfo[allGames[gameId].activePlayer].playerTime * (-1/3)) 
